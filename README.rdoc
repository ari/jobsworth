...
After all that setup we can now install the software. Just take the file ROOT.war from the github release and copy it into the webapps folder inside tomcat.
