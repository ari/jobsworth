...
This is a false error, there is sometimes a problem with ruby 1.9.2 and rvm.  To try and fix this, as <b>root</b> again, type the following:
    * <b>rvm --force install 1.9.2</b> - This will reinstall the ruby intrepertor, just in case something got corrupted
    * <b>gem install bundle</b> - This will reinstall bundle using the default gem command, this usually fixes the error
