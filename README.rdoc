...
{<img src="https://travis-ci.org/ari/jobsworth.svg?branch=master" alt="Build Status" />}[https://travis-ci.org/ari/jobsworth]
...
Enable logstash sending in context.xml in order to receive beautiful looking logs in your kibana/logstash/elasticsearch system.
