...
Copy the latest release from https://github.com/ari/jobsworth/releases  All you need is the "war" file which goes into the 'webapps' folder inside your Tomcat installation.
