...
Change directory into the top of the jobsworth installation folder and then run the set up script.
...
[Continuous build server]  http://travis-ci.org/ari/jobsworth

[Test status]              {<img src="https://secure.travis-ci.org/ari/jobsworth.png" />}[http://travis-ci.org/ari/jobsworth]
