**** The refactoring branch is not production-ready! (beware of regresion errors) ****
...
|  !https://secure.travis-ci.org/ari/jobsworth.png! |     |


== License

Copyright (c) 2008-2012 Aristedes Maniatis. All rights reserved.
