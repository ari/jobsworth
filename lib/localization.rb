module Localization
  ...
  def self.locales
    [['English', 'en_US'], ['Dansk', 'dk_DK'], ['Deutsch', 'de_DE'], ['Euskara', 'eu_ES'], ['Español', 'es_ES'], ['Français', 'fr_FR'], ['Italian', 'it_IT'], ['Nederlands', 'nl_NL'], ['Norsk', 'no_NO'], ['Português Brazilian', 'pt_BR'], ['Svensk', 'sv_SV']]
  end
