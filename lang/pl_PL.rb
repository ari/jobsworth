Localization.define('pl_PL') do |l|
  ...
  l.store "by", "przez"
  l.store "of", "z"
  l.store "or", "lub" # GhandaL
  l.store "Add", "Dodaj" # chester
  l.store "Age", "Wiek" # chester
  l.store "All", "Wszystkie"
  l.store "Apr", "Kwi"
  l.store "Aug", "Sie"
  l.store "CSV", "CSV" # chester
  l.store "Dec", "Gru"
  l.store "Due", "Na" # Paweł Besser
  l.store "End", "Koniec" # chester
  l.store "Feb", "Lut"
  l.store "Fri", "Pt"
  l.store "Jan", "Sty"
  l.store "Jul", "Lip"
  ...
  l.store "Tue", "Wt"
  l.store "Wed", "Śr"
  l.store "ago", "temu" # chester
  l.store "and", "i"
  l.store "day", "dzień"
  l.store "Body", "Treść"
  l.store "Chat", "Czat"
  l.store "Date", "Data"
  l.store "Days", "Dni" # GhandaL
  l.store "Edit", "Edytuj"
  ...
  l.store "To-do", "To-do" # chester
  l.store "Today", "Dzisiaj"
  l.store "Topic", "Temat" # chester
  l.store "Total", "Razem"
  l.store "Users", "Użytkownicy"
  l.store "Views", "Widoki"
  l.store "Weeks", "Tygodnie" # Marcin
  l.store "every", "każdy"
  l.store "lists", "listy" # Marcin H
  l.store "today", "dziś"
  l.store "until", "dopóki" # GhandaL
  l.store "%d day", ["dzień", "%d dni"]
  l.store "%s ago", "%s temu"
  l.store "*bold*", "*pogrubiony*" # chester
  l.store "Assign", "Przypisanie"
  l.store "August", "Sierpień"
  l.store "Browse", "Przeglądaj"
  l.store "Cancel", "Anuluj" # GhandaL
  ...
  l.store "Forums", "Fora" # GhandaL
  l.store "Friday", "Piątek"
  l.store "Locked", "Zablokowany" # chester
  l.store "Lowest", "Najniższy"
  l.store "Monday", "Poniedziałek"
  l.store "Months", "Miesiące" # GhandaL
  ...
  l.store "Sticky", "Przyklejony" # chester
  ...
  l.store "[wdhm]", "[tdgm]"
  l.store "cancel", "Anuluj" # chester
  l.store "quotes", "quotes"
  l.store "%d days", ["%d dzień", "%d dni"] # GhandaL
  l.store "%d file", ["%d plik", "%d pliki"]
  l.store "%d more", ["%d więcej", "%d więcej"] # Lukas
  ...
  l.store "offline", "offline" # chester
  l.store "page %s", "strona %s" # Paweł Besser
  ...
  l.store "2w 3d 1h", "2w 3d 1h" # fredd4
  l.store "Any Room", "Wszystkie pokoje" # chester
  ...
  l.store "Estimate", "Szacowanie" # grafnet
  ...
  l.store "[Delete]", "[Usuń]"
  l.store "[No one]", "[Nikt]" # Marcin H
  l.store "tomorrow", "jutro"
  l.store "%d folder", ["%d  folder", "%d foldery"] # chester
  l.store "%d minute", ["minuta", "%d minut"]
  l.store "%d topics", ["%d temat", "%d tematy"] # Radek Czarnecki
  l.store "%d voices", ["%d głosów", "%d głosów"] # chester
  l.store "Completed", "Ukończony"
  l.store "Due Tasks", "Zadania do wykonania" # Paweł Besser
  ...
  l.store "Edit post", "Edytuj post" # chester
  l.store "Estimated", "Oszacowany" # GhandaL
  l.store "Last Post", "Ostatni post" # GhandaL
  l.store "Last Week", "Ostatni tydzień"
  l.store "Last Year", "Ostatni rok"
  l.store "Last post", "Ostatnie posty" # chester
  l.store "Milestone", "Kamień milowy" # Marcin
  l.store "New Topic", "Nowy Temat" # Marcin H
  l.store "New topic", "Nowy temat" # chester
  l.store "Next Week", "Następny tydzień" # GhandaL
  l.store "Next week", "Następny tydzień" # GhandaL
  l.store "One month", "Jeden miesiąc" # GhandaL
  l.store "Remaining", "Pozostałe" # GhandaL
  l.store "Revisions", "Revisions" # chester
  ...
  l.store "Translate", "Przetułmacz" # Radek Czarnecki
  l.store "Use Forum", "Użyj Forum" # Radek Czarnecki
  l.store "Wednesday", "Środa"
  l.store "Won't Fix", "Nie naprawiony"
  l.store "Won't fix", "Nie do naprawy" # chester
  l.store "Work Done", "Zadanie Wykonane" # Radek Czarnecki
  l.store "Yesterday", "Wczoraj" # GhandaL
  l.store "_italics_", "_kursywa_" # chester
  l.store "entries..", "wpisów.."
  l.store "yesterday", "wczoraj"
  l.store "%d day ago", ["dzień temu", "%d dni temu"]
  l.store "%d project", ["%d projekt", "%d projekt"] # chester
  ...
  l.store "Delete All", "Usuń wszystkie" # chester
  l.store "Depends on", "Zależy od"
  l.store "Edit Forum", "Edytuj Forum" # chester
  l.store "Edit Topic", "Edytuj Tytuł" # Lukas
  ...
  l.store "Leave Room", "Opuść Pokój" # chester
  l.store "Leave room", "Opuść pokój" # chester
  l.store "Loading...", "Ładowanie..." # chester
  l.store "Local Time", "Czas lokalny" # GhandaL
  l.store "Milestones", "Kroki"
  l.store "Moderators", "Moderatorzy" # chester
  l.store "New Avatar", "Nowy awatar" # GhandaL
  l.store "New Client", "Nowy klient" # GhandaL
  l.store "New Folder", "Nowy folder" # GhandaL
  l.store "Next month", "Następny miesiąc" # GhandaL
  l.store "Open Tasks", "Otwarte zadania"
  l.store "Post Topic", "Publikuj Temat" # Marcin H
  l.store "Prioritize", "Priorytet"
  l.store "Reassigned", "Ponownie przypisany" # chester
  l.store "Run Report", "Pokaż raport"
  l.store "Save Reply", "Zapisz odpowiedź" # chester
  ...
  l.store "Total Done", "Wszystkich wykończonych" # fredd4
  ...
  l.store "Change room", "Zmień pokój" # chester
  ...
  l.store "Revision %s", "Revision %s" # chester
  ...
  l.store "Last %d Days", ["Ostatni %d Dzień", "Ostatnie %d Dni"] # Lukas
  ...
  l.store "Save as View", "Zapisz jako Widok" # chester
  l.store "Send Message", "Wyślij wiadomość" # chester
  l.store "Show Avatars", "Pokaż avatary" # chester
  l.store "Show History", "Pokaż historię" # chester
  ...
  l.store "about 1 year", "około roku" # chester
  ...
  l.store "about 1 month", "około 1 miesiąca" # chester
  l.store "half a minute", "pół minuty"
  l.store "Add New Widget", "Dodaj nowy widget" # chester
  ...
  l.store "Reply to topic", "Odpowiedź do tematu" # Marcin H
  ...
  l.store "Wiki Additions", "Dodatki Wiki" # chester
  ...
  l.store "Archive Messages", "Archiwizuj wiadomości" # chester
  ...
  l.store "Messages from %s", "Wiadomości od %s" # chester
  l.store "Monitoring forum", "Monitoring forum"
  l.store "Monitoring topic", "Monitoring topic"
  l.store "Open to %s users", "Otwarty dla %s użytkowników" # chester
  l.store "Open to everyone", "Otwarty dla wszystkich" # chester
  ...
  l.store "Hide Dependencies", "Ukryj zależności" # fredd4
  ...
  l.store "Under revision by", "Edytowane przez" # Paweł Besser
  l.store "Upload more files", "Prześlij więcej plików" # Paweł Besser
  ...
  l.store "%d open / %d tasks", ["%d otwarte / %d zadanie", "%d otwarte / %d zadania"] # Lukas
  ...
  l.store "Last active %s ago", "Ostatnio aktywny %s temu" # chester
  ...
  l.store "Really delete tag?", "Naprawdę usunąć tag?" # Lukas
  ...
  l.store "Find a Google Gadget", "Znajdź Google Gadget" # Lukas
  ...
  l.store "Restricted Messaging", "Ograniczone wysyłanie wiadomości" # chester
  ...
  l.store "Download Database Dump", "Pobierz Zrzut Bazy Danych" # Lukas
  l.store "Edit project <b>%s</b>", "Edytuj projekt <b>%s</b>" # GhandaL
  l.store "Floating Messaging Bar", "Pływający pasek wiadomości" # chester
  l.store "Hide Task Dependencies", "Ukryj zależności zadania" # fredd4
  l.store "View '%s' was deleted.", "Widok '%s' usunięty." # GhandaL
  l.store "invite some co-workers", "zaproś współpracowników" # chester
  l.store "Last %d Completed Tasks", ["Ostatnie %d Zakończone Zadanie", "Ostatnie %d Zakończone Zadania"] # Lukas
  ...
  l.store "and copy permissions from", "i skopiuj uprawnienia od" # chester
  l.store "CSS successfully uploaded.", "CSS załadowany."
  l.store "Delete this topic forever?", "Wykasuj ten temat na zawsze?" # Marcin H
  ...
  l.store "Only admins can edit users.", "Tylko administrator może zmieniać użytkowników." # Paweł Besser
  ...
  l.store "Only show tasks of this type", "Pokazuj tylko taski tego typu" # Lukas
  l.store "Really delete whole history?", "Czy na pewno usunąć historię ?" # chester
  ...
  l.store "Changes are not made live instantly.", "Zmiany  NIE są widoczne bezpośrednio po zapisaniu." # chester
  ...
  l.store "Show tasks with at least this priority", "Pokazuj zadania z przynajmniej takim priorytetem" # Lukas
  l.store "Show tasks with at least this severity", "Pokaż zadania z przynajmniej tym rygorem" # Lukas
  ...
  l.store "Show icons next to tasks representing their type.", "Pokaż ikony obok zadań reprezentujące ich typ." # Lukas
  l.store "The message will be included in the signup email.", "Wiadomość zostanie dołączona do emaila z rejestracją"
  l.store "Unable to find that task in any of your projects.", "Nie znaleziono tego zadania w żadnym z twych projektów." # Lukas
  l.store "Start working on <b>%s</b>. Click again when done.", "Rozpocznij pracę nad <b>%s</b>. Naciśnij jeszcze raz kiedy skończysz."
  l.store "Unable to find task belonging to you with that ID.", "Nieznaleziono zadań należących do ciebie z tym ID." # Lukas
  ...
  l.store "You don't have access to create tasks on this project.", "Nie masz dostępu aby tworzyć zadania w tym projekcie." # Lukas
  ...
  l.store "Either the milestone doesn't exist, or you don't have access to it.", "Ten kamień milowy nie istnieje lub nie masz do niego dostępu." # Lukas
  l.store "Text entered will be saved automatically to your current work notes.", "Wpisana treść zostanie automatycznie zapisana do notatek" # chester
  l.store "For a personal feed, replace <b>ical_all</b> with <b>ical</b> in the URL.", "Dla własnej syndykacji, zastąp <b>ical_all</b> słowem <b>ical</b> w adresie URL." # chester
  l.store "You're not allowed to create new projects. Have your admin give you access.", "Nie masz możliwości tworzenie projektów. Skontaktuje się ze swoim administratora aby uzyskać uprawnienia" # Marcin H
  ...
  l.store "The last thing to do, is %s unless you're working alone. Once you have created logins for them, grant them access to the projects they are to work on from the Edit Project page, accessible from the %s.", "Ostatnia sprawa jeśli nie pracujesz sam nad projektem - możesz %s . Po utworzeniu loginów dla każdego współpracownika musisz przydzielić im uprawnienia do projektu na stronie Edycji Projektu  dostępnych z %s." # chester
end
