Localization.define('it_IT') do |l|
  ...
  l.store '[Prev]', '[Precedenti]' # [Prev] 100 of 2000 entries [Next]
  l.store '[Next]', '[Prossimi]' # [Prev] 100 of 2000 entries [Next]
  l.store 'of', 'di' # 100 of 2000 entries
  l.store 'entries..', 'voci..' # 100 of 2000 entries
