Localization.define('es_ES') do |l|
  ...
  l.store "New File", "Nuevo Fichero" # Sergio Rael
  l.store "New Note", "Nueva nota"
  l.store "New Room", "Nueva Sala" # Sergio Rael
  l.store "New Task", "Nueva tarea"
  l.store "New User", "Nuevo Usuario" # Sergio Rael
  ...
  l.store "Workload", "Carga de Trabajo" # Sergio Rael
  l.store "[Delete]", "[Borrar]"
  l.store "tomorrow", "mañana"
  l.store "%d folder", ["%d directorio", "%d directorios"] # Sergio Rael
  ...
  l.store "New Avatar", "Nuevo Avatar" # Sergio Rael
  l.store "New Client", "Nuevo cliente"
  l.store "New Folder", "Nuevo Directorio" # Sergio Rael
  ...
  l.store "Save Reply", "Guardar Respuesta" # Sergio Rael
  ...
  l.store "[Any Task]", "[Cualquier Tarea]" # Sergio Rael
  ...
  l.store "Public Forums", "Foros Públicos" # Sergio Rael
