...
* Bootstrap CSS framework imported so there is a major design makeover
...
* Email addresses can no longer be added to a task. You now have to create a new user. For orhpaned email addresses attached to tasks
