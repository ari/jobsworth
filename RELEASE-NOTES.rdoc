...
* IMPORTANT: Remove the project files feature. Files linked to tasks are not affected. If you are looking for a broader file sharing system per project, we recommend DropBox, Google Files, or one of many other similar tools.  If you had project files which were important to you, make sure you save them before upgrading.
