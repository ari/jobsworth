...
set :repository, "http://darcs.clockingit.com/stable"
...
# OPTIONAL VARIABLES
# =============================================================================
set :deploy_to, "/usr/local/www/apps/#{application}" # defaults to "/u/apps/#{application}"
...
desc "shared /tmp folder, and migrations"
