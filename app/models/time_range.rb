...
class TimeRange < ActiveRecord::Base
  ...
  DEFAULTS = [
              ...
              [ I18n.t('time_key_words.tomorrow_or_earlier'), { :start => "Date.utc(1000)", :end => "Date.tomorrow" } ],
...
private
  RANGES= {
    ...
    :'Yesterday' => ['Time.now.yesterday.beginning_of_day.utc','Time.now.yesterday.end_of_day'],
    :'Tomorrow'   => ['Time.now.tomorrow.beginning_of_day.utc','Time.now.tomorrow.end_of_day.utc'],
    ...
    :'In the Past'=> ['Time.utc(1000)', 'Time.now.beginning_of_day.utc'],
    :'In the future' => ['Time.now.tomorrow.beginning_of_day.utc','Time.utc(2100)'],
    :'Yesterday or earlier'=> ['Time.utc(1000)', 'Time.yesterday.end_of_day.utc'],
    :'Yesterday or later' => ['Time.now.yesterday.beginning_of_day.utc','Time.utc(2100)'],
    :'Tomorrow or earlier' =>['Time.utc(1000)', 'Time.tomorrow.end_of_day.utc'],
    :'Tomorrow or later' => ['Time.now.tomorrow.beginning_of_day.utc','Time.utc(2100)'],
    :'Today or earlier'=> ['Time.utc(1000)', 'Time.now.end_of_day.utc'],
    :'Today or later' => ['Time.now.beginning_of_day.utc','Time.utc(2100)'],
  }
