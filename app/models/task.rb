...
#  end
  ...
  def icon(icon_type = nil)
    icon_type ||= type_id
    case icon_type
      when 0 then '<img src="/images/add.png" alt="Task" title="Task" class="tooltip" />'
      when 1 then '<img src="/images/application_add.png" alt="New Feature" title="New Feature" class="tooltip" />'
      when 2 then '<img src="/images/bug_add.png" alt="Defect" title="Defect" class="tooltip" />'
      when 3 then '<img src="/images/application_form_edit.png" alt="Improvement" title="Improvement" class="tooltip" />'
    end 
  end 
