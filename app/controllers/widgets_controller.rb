class WidgetsController < ApplicationController
  ...
  def show
    ...
    when 1
      # Project List
      @projects = current_user.projects.find(:all, :order => 't1_r2, projects.name', :conditions => ["projects.completed_at IS NULL AND milestones.completed_at IS NULL"], :include => [ :customer, :milestones])
